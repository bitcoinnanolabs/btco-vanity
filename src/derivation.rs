...
pub fn pubkey_to_address(pubkey: [u8; 32]) -> String {
    ...
    reverse_chars.extend(b"_octb"); // btco_ reversed
    reverse_chars
        .iter()
        .rev()
        .map(|&c| c as char)
...
mod tests {
    ...
    fn test_ed25519_secret_to_pubkey() {
        ...
        // Address: btco_3ot3ctc5dq6pm4ogcabcafzouuf9fuy6748c9z8ykr43k4n85zi9zec5bxnz
    ...
    fn test_pubkey_to_address() {
        ...
        assert_eq!(
            ...
            "btco_3ot3ctc5dq6pm4ogcabcafzouuf9fuy6748c9z8ykr43k4n85zi9zec5bxnz"
        );
    }
}
